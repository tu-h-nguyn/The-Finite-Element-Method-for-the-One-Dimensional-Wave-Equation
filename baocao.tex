...
tại $1$, đúng như Định lý~\ref{thm:spectrum}.}
\label{fig:stability}
\end{figure}
...
\caption{Năng lượng rời rạc $\mathcal{E}^{n+1/2}$ chuẩn hóa theo thời gian
($N = 80$). Với $\theta < \theta^{*}$ năng lượng được bảo toàn chính xác;
với $\theta > \theta^{*}$ nó tăng theo cấp số nhân.}
\label{fig:energy}
\end{figure}
